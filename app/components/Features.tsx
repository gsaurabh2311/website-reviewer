import FeatureFirst from "../../public/assets/feature-1.svg";
import FeatureSecond from "../../public/assets/feature-2.svg";
import FeatureThird from "../../public/assets/feature-3.svg";
...
export function Features() {
  return (
    <div className="flex flex-col gap-y-[56px] py-[56px] lg:py-[120px] lg:gap-y-[80px] px-[20px]">
      <div className="flex flex-col gap-x-6 sm:flex-row-reverse">
        ...
        <div className="sm:w-1/2 lg:py-[56px] lg:pr-[56px]">
          ...
          <h1 className="pt-[12px] text-2xl font-medium text-[#172026] lg:text-[48px] lg:leading-[58px]">
          ...
          <p className="flex items-center gap-x-2 pt-[24px] font-medium text-[#0085FF] lg:text-[18px] lg:pt-[32px]">
            Learn More{" "}
            <span>
      ...
      <div className="flex flex-col gap-x-6 sm:flex-row">
        ...
        <div className="sm:w-1/2 lg:py-[56px] lg:pl-[56px]">
          ...
          <p className="flex items-center gap-x-2 pt-[24px] font-medium text-[#00A424] lg:text-[18px] lg:pt-[32px]">
            Learn More{" "}
            <span>
      ...
      <div className="flex flex-col gap-x-6 sm:flex-row-reverse">
        ...
        <div className="sm:w-1/2 lg:py-[56px] lg:pr-[56px]">
          ...
          <div className="flex w-full gap-x-[24px] lg:pt-[32px]">
          ...
          <p className="flex items-center gap-x-2 pt-[24px] font-medium text-[#EB2891] lg:text-[18px] lg:pt-[32px]">
            Learn More{" "}
            <span>
